...
if (!isset($_SESSION['login_sess'])) {
   echo '
     <script>
        ...
        window.location = "http://tropbot-ljp-tg.125mb.com/usersLogin/logout.php";
     </script>';
     exit();
...
<div class="page-flex">
  ...
  <aside class="sidebar">
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="/usersLogin/dashboard.php" class="logo-wrapper" title="Home">
                ...
                <div class="logo-text">
                    <span class="logo-title">TROPBOT-LJP</span>
        ...
        <div class="sidebar-body">
            ...
            <span class="system-menu__title">Descargas</span>
            
            <ul class="sidebar-body-menu">
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon category" aria-hidden="true"></span>Imágenes
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="https://www.dropbox.com/sh/dxdyfi3d7q7y1yy/AABMfV91UkYh7s5sKPYBAbaXa?dl=0">Último recorrido</a>
                        </li>
                        <li>
                            <a href="https://www.dropbox.com/sh/dy6s0hx2hsignrk/AADKmpzHtBPJcLB4Gdb8SEpua?dl=0">Histórico
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="sidebar-footer">
        <a href="https://www.dropbox.com/sh/dbr0ywvjt2k1olv/AADQtWQONi392p7Ynt4X7AdKa?dl=0" class="sidebar-user">
         ...
         <!-- ////////////////////////////////////////////////////////////////////////////////////////////-->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Reporte Mensual de <strong>Dióxido de Carbono</strong> </h5>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="text-center">
                                                <strong>Dióxido de Carbono por Regiones</strong>
                                            </p>
                                            <div class="chart">
                                                <!-- Sales Chart Canvas -->
                                                <iframe width="705" height="365" style="border: 3px solid #cccccc;" src="https://thingspeak.com/apps/matlab_visualizations/436768?width=690&height=350">
                                                </iframe>
                                            </div>
                                            <!-- /.chart-responsive -->
                                        </div>      
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 col-8">
                                            <div class="description-block border-right">
                                                <h5 class="description-header">Valor mínimo de Dióxido de Carbono</h5>
                                                <iframe width="90" height="50" style="border: 3px solid #fc021a;" src="https://thingspeak.com/apps/matlab_visualizations/436875?width=50&height=50"></iframe>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-4 col-8">
                                            <div class="description-block border-right">
                                                <h5 class="description-header">Valor promedio de Dióxido de Carbono</h5>
                                                <iframe width="90" height="50" style="border: 3px solid #fb5c04;" src="https://thingspeak.com/apps/matlab_visualizations/436874?width=50&height=50"></iframe>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-4 col-8">
                                            <div class="description-block border-right">
                                                <h5 class="description-header">Valor máximo de Dióxido de Carbono</h5>
                                                <iframe width="90" height="50" style="border: 3px solid #f9b900;" src="https://thingspeak.com/apps/matlab_visualizations/436876?width=50&height=50"></iframe>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
