<?php
 ...
 if (!empty($_POST['firstName']) && !empty($_POST['lastName']) && !empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['check_password'])) { /*Verificar que no este vacío*/
        ...
        $conexion = mysqli_connect("fdb31.125mb.com", "3963737_userstropbot", "TROPBOT5479_IoT", "3963737_userstropbot");
        $Email = $_POST['email'];
        $verifyEmail= mysqli_query($conexion, "SELECT * FROM login_users WHERE email ='$Email'"); 
        ...
        elseif(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
           ...
           require 'database.php';
            ...
            $sql = "INSERT INTO login_users (firstName, lastName, email, password,check_password) VALUES (:firstName, :lastName, :email, :password,:check_password)";
...
<head>
  ...
  <title>TROPBOT TG || Porque sabemos que amas tu cultivo | Registrarse  </title>
