...
<head>
  ...
  <title>TROPBOT TG || Porque sabemos que amas tu cultivo  | Dashboard</title>
  <!-- Favicon -->
        ...
        <div class="col-md-6 col-xl-4">
          <article class="stat-cards-item">
            ...
            <div class="stat-cards-info">
              ...
              <p class="stat-cards-info__title">(Temperatura, Humedad Relativa del aire, Radiación e Iluminación Solar, Dióxido de carbono)
              </p>
            </div>
          </article>
        </div>
        ...
        <div class="col-md-6 col-xl-6">
          <article class="stat-cards-item">
            ...
            <div class="stat-cards-info">
              ...
              <p class="stat-cards-info__title">Por recorrido o el histórico completo en formato CSV y las imágenes de cada recorrido o el histórico en un archivo ZIP.</p>
