...
#
#   Return:  Retorna un valor booleano 1 o 0
#
#   Purpose: Conocer si se pudo realizar conexion con la antena
#
#   Plan
#           Part 1: Verificar si se lee la trama de datos GPRMC
#
...
#   sym_to_text(data);
#
#   Return:  Una trama string con valores de latitud,longitud,fecha y hora
#
#   Purpose: Extrar las coordenadas de la trama del GPS
#
#   Plan
#           Part 1: Reconocer la trama
#           Part 2: Extraer la hora 
#           Part 3: Extraer la latitud
#           Part 4: Extraer la longitud
#           Part 5: Extraer la fecha
#           Part 6: Retornar la trama 
#
#   Register of Revisions (Debugging Process):
#
#   DATE       RESPONSIBLE  			COMMENT
